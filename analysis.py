...
def Histogram(B, G, R):
    ...
    plt.title("Image B-channel histogram")
    plt.xlabel("B-channel pixel gray value")
    ...
    plt.title("Image G-channel histogram")
    plt.xlabel("G-channel pixel gray value")
    plt.ylabel("Frequency")
    plt.ylim(0, 5000)
    plt.show()

    plt.hist(R.ravel(), 256)
    plt.title("Image R-channel histogram")
    plt.xlabel("R-channel pixel gray value")
    plt.ylabel("Frequency")
    plt.ylim(0, 5000)
    plt.show()
...
if __name__ == '__main__':
    img = cv.imread(r"C:\Users\15003\Desktop\data\enc.png")
    B = img[:, :, 0]
    G = img[:, :, 1]
    R = img[:, :, 2]
    Histogram(B, G, R)
